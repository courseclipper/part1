...
function Catagory() {
  ...
  const OnDeleteCatHandler = async (event, cat) => {
    ...
    try {
      const response = await axios.delete(`http://http://ec2-18-134-228-189.eu-west-2.compute.amazonaws.com//category/delete/${cat.name}`);
  ...
  const AddCategoryHandler = async (e) => {
    ...
    try {
      ...
      const response = await axios.get('http://http://ec2-18-134-228-189.eu-west-2.compute.amazonaws.com//category', requestOptions);
  ...
  const PlatformAddHandler = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://http://ec2-18-134-228-189.eu-west-2.compute.amazonaws.com//platform', data_platform);
      if (response.statusText == 'OK') {
  ...
  const PlatformDeleteHandler = async (e, name_plat) => {
    e.preventDefault();
    try {
      const response_del = await axios.delete(`http://http://ec2-18-134-228-189.eu-west-2.compute.amazonaws.com//platform/${name_plat}`);
  ...
  useEffect(() => {
    axios.get("http://http://ec2-18-134-228-189.eu-west-2.compute.amazonaws.com//category").then((response) => {
      setCategory(response.data.Categories);
    }).catch((error) => {
      console.log(error);
    })

    axios.get("http://http://ec2-18-134-228-189.eu-west-2.compute.amazonaws.com//platform").then((response) => {
