...
function Catagory() {
  ...
  const OnDeleteCatHandler = async (event, cat) => {
    ...
    try {
      const response = await axios.delete(`https://course-clipper.onrender.com/category/delete/${cat.name}`);
  ...
  const AddCategoryHandler = async (e) => {
    ...
    try {
      ...
      const response = await axios.get('https://course-clipper.onrender.com/category', requestOptions);
  ...
  const PlatformAddHandler = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('https://course-clipper.onrender.com/platform', data_platform);
      if (response.statusText == 'OK') {
  ...
  const PlatformDeleteHandler = async (e, name_plat) => {
    e.preventDefault();
    try {
      const response_del = await axios.delete(`https://course-clipper.onrender.com/platform/${name_plat}`);
  ...
  useEffect(() => {
    axios.get("https://course-clipper.onrender.com/category").then((response) => {
      setCategory(response.data.Categories);
    }).catch((error) => {
      console.log(error);
    })

    axios.get("https://course-clipper.onrender.com/platform").then((response) => {
